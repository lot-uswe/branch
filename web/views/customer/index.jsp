            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        ...
                        <!-- Single Wedge End -->
<%--                        通过我们的分析，这个offcanvas-toggle会在main.js中做出了处理--%>
<%--                        所以我们可以将该class先去掉，恢复超链接的本身的机制
                            编程的思想和方式真的很重要--%>
                        <a href="views/cart/cart.jsp"
                           class="header-action-btn header-action-btn-cart pr-0">
                            <i class="icon-handbag"> 购物车</i>
<%--                            ${sessionScope.cart.totalCount}本质就是调用这个getTotalCount的方法--%>
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        ...
        <%--                <li><a href="#">4</a></li>--%>
        <%--                <li><a href="#">5</a></li>--%>
        <%--                显示所有的分页数,先写容易的，再写困难的--%>
        <%--                先确定，所开始的页数，begin，第一页--%>
        <%--                再确定，所结束的页数，end，最后一页 第pageTotalCount--%>
        <%--                    如果页数很多怎么办呢？，可以使用算法，先最多显示5页--%>
